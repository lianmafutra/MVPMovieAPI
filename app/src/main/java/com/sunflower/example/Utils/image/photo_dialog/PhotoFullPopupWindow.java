package com.sunflower.example.Utils.image.photo_dialog;
...
import com.sunflower.example.Constant.Text;
...
public class PhotoFullPopupWindow extends PopupWindow {
    ...
    public PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        ...
        if (imageUrl.isEmpty()){
            Toast.makeText(ctx, Text.no_photoDialog, Toast.LENGTH_SHORT).show();
        }
        else {
